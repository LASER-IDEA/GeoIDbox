...
While Neural Fields have revolutionized computer vision, their application to geospatial regression and atmospheric parameter estimation remains largely underexplored. Furthermore, training Neural Fields on spatially heterogeneous IoT data presents severe convergence challenges. Inspired by Bengio \textit{et al.} \cite{bengio2009curriculum}, Curriculum Learning—a strategy of training models on progressively harder examples—offers a potential solution. In this paper, we pioneer the adaptation of hash-encoded Neural Fields for metrological applications. By coupling curriculum learning with physics-informed atmospheric constraints, we transform Neural Fields into a highly accurate, physically consistent spatial measurement tool.
